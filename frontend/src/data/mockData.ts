...
export const snapshot: PageSnapshot = {
  ...
  reconstruction: {
    id: 'reconstruction-1', status: 'PARTIAL', kind: 'STATIC_PAGE_ARCHIVE',
    engineVersion: 'weblens-1/pagesource-0.1.2@f59ed61', packagedCount: 5,
    skippedCount: 1, archiveBytes: 946321, completenessCode: 'RESOURCE_GAPS',
    failureCode: null, expiresAt: '2026-09-20T13:18:00Z', downloadAvailable: true,
  },
  resources: [
